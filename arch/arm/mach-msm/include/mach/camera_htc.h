...
struct msm_queue_cmd_t {
	...
	/* 0 - control command or control command status;
	 * 1 - adsp event;
	 * 2 - adsp message;
	 * 3 - v4l2 request;
	 */
...
long msm_v4l2_register(struct msm_driver *, const char *);
long msm_v4l2_unregister(struct msm_driver *, const char *);
